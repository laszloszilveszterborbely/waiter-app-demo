...
public class Reservation extends RestaurantEntity {
	...
	public Reservation(LocalDate date, LocalTime time, String name, Long phoneNumber, Integer numberOfPeople,
			String notes) {
		super();
		this.date = date;
		this.time = time;
	...
	public Reservation(LocalDate date, LocalTime time, String name, Long phoneNumber, Integer numberOfPeople,
			String occasion, Boolean isPayDeposit, Boolean isOrderedMeal, Boolean needHighChair, Boolean isThereCake,
			String notes, String courses, String tableNumber, Boolean isActive) {
		super();
		this.date = date;
		this.time = time;
		this.name = name;
	...
	public String toCounter() {
		...
		String table = (tableNumber == null || tableNumber.isEmpty()) ? "" : ("Asztal: " + tableNumber + "\n");
